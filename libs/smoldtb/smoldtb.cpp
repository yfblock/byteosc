 ...
 * array element is non-null, it points to the dtb_node struct representing the
...
static dtb_node *parse_node(size_t *offset, uint8_t addr_cells,
                            uint8_t size_cells) {
...
static dtb_node *find_child_internal(dtb_node *start, const char *name,
                                     size_t name_bounds) {
